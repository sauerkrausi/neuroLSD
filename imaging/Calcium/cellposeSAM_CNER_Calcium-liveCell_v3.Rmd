---
title: "cellposeSAM_CNER_Calcium-liveCell_v3_diff138_d38"
...
## IIb3. Helper Function – parse through matched df folder and add metadata
```{r}
# -----------------------------
# Define paths
# -----------------------------
annotated_dir <- file.path(base_path, "02_annotated_dfs")
out_dir <- file.path(base_path, "03_combined_dfs")
...
# Run the function
# -----------------------------
combined_dfs <- build_centroid_intensity_dfs(annotated_dir, out_dir)
