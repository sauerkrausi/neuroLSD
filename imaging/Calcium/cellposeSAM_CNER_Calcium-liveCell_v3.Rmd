...
## IId5. Trace Plotting (per sample), Correlations, Network plots and Firing Statistics 
```{r}
# Setup
...
for (sample_id in all_sample_ids) {
  ...
  # Continue with: high-corr ROI extraction, firing stats, burst filtering, and network plots
}
