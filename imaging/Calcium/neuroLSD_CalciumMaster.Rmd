...
# --- Save plot
ggsave(filename = file.path(camaster_plot_outdir, "Inhibitor_Effect_Ctrl.pdf"),
       plot = inhibitor_plot, width = 5, height = 4, device = cairo_pdf)
...
# --- Save plot
ggsave(filename = file.path(camaster_plot_outdir, "Inhibitor_Effect_Ctrl_normalized.pdf"),
       plot = inhibitor_plot_norm, width = 5, height = 4, device = cairo_pdf)
```
