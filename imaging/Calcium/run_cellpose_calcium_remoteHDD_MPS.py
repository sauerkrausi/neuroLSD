...
io.logger_setup() # run this to get printing of progress in terminal output panel 


# Set up input and output directories for ND2 files and label outputs
#folder = Path("nd2")
folder = Path("/Users/felix/Desktop/cpdemo/nd2")
...
# Explicitly set MPS device for Mac
