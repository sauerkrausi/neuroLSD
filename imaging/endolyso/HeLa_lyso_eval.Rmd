...
# quick check of parsed counts
parsed_counts_tbl <- coloc_df %>%
  count(genotype, treatment, name = "n_images")

print(parsed_counts_tbl)
...
# plot frac_coloc_eea1 by genotype and treatment
coloc_df <- coloc_df %>%
  mutate(
...
ggsave(file.path(metrics_dir, "HeLa_EEA1-TFN_coloc.pdf"), plot_frac_coloc_eea1, width = 4, height = 3,device = cairo_pdf)
