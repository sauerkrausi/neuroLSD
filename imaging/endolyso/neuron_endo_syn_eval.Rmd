...
# Output
eval_output_dir  <- file.path(eval_base_dir, "..", "combined_eval")
...
# Run function once to get combined dataframe
# combined_df <- eval_combine_and_save(eval_input_tbl, eval_output_file)
