...
# Analysis parameters
baseline_window <- 150    # Rolling window size for baseline (frames)  
frame_rate      <- 10
smoothing_k     <- 1      # Optional smoothing over raw intensity traces (frames), set to NULL to disable smoothing
window          <- 250.   # Window for rolling baseline calculation in second pass
